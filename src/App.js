...
import './App.css';
 ...
 class App extends Component {
	 ...
	 render() { 
		 return ( this.state.login?<div className="div1">
			 ...
			 <div>
				 ...
				 <button onClick={()=>this.setState({username : "",password : ""})}>Done</button>
				 <br/><br/><br/><br/>
				 &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				 <button onClick={()=>this.setState({login : false})} className="button">SignUp</button>
			...
			<div>
				...
				<br/><br/>
				<input type="text" value={this.state.age} onChange={e=>{this.setState({age : e.target.value})}} placeholder="Age" required/>
				<br/><br/>
				<input type="text" value={this.state.username} onChange={e=>{this.setState({username : e.target.value})}} placeholder="UserName" required/>
				<br/><br/>
				<input type="password" value={this.state.password} onChange={e=>{this.setState({password : e.target.value})}} placeholder="PassWord" required/>
				<br/><br/>
				&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				<button onClick={()=>this.setState({username : "",password : "",email : "",age : ""})}>Done</button>
				<br/><br/><br/><br/>
				 &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				<button onClick={()=>this.setState({login : true})} className="button">Login</button>
